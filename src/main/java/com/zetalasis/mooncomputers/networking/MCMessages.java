...
public class MCMessages {
    ...
    public static final Identifier COMPUTER_INPUT_EVENT_C2S = MoonComputers.location("computer_input_event_c2s");
    ...
    public static final Identifier COMPUTER_SOUND_UPDATE_S2C = MoonComputers.location("computer_sound_update_s2c");
}