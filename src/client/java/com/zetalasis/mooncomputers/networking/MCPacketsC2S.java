...
import com.zetalasis.mooncomputers.networking.packet.s2c.ComputerSoundUpdateS2C;
...
public class MCPacketsC2S {
    public static void register()
    {
        ...
        ClientPlayNetworking.registerGlobalReceiver(MCMessages.COMPUTER_SOUND_UPDATE_S2C, ComputerSoundUpdateS2C::handle);
    }
